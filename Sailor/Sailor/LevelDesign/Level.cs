                ...
                for (int x = 0; x < SurroundingsArray.GetLength(1); x++)
                {
                    switch (SurroundingsArray[y, x])
                    {
                        ...
                        case 9:
                            ...
                            break;
                        case 10:
                            Surroundings.Add(new StaticBlok(surrTextures[SurroundingObjects.Object][4],
                                new Vector2(x * 64, y * 16 + 2)));
                            break;
                        default:
                            break;
                    }
                ...
                for (int x = 0; x < ForegroundArray.GetLength(1); x++)
                {
                    ...
                    switch (ForegroundArray[y, x])
                    {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            Foreground.Add(new StaticBlok(foreTextures[SurroundingObjects.Object][0],
                                new Vector2(x * 64, y * 16)));
                            break;
                        case 10:
